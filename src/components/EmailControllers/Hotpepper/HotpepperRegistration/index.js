...
const secretTootlTipTitle =
  "「ホットペッパー店舗管理画面」にログイン＞「機能設定」を選択＞「機能メール設定」の「確認する」からメールアドレスを登録してください。";
export default function HotpepperRegistration() {
      ...
      <Row className="form-section">
        <Col md={{ span: 20, offset: 2 }}>
          <div className="registration-email-title">
            <span>
              ホットペッパー管理画面にて取込専用メールアドレスを登録してください。
            </span>
          </div>
        ...
        <Col md={{ span: 20, offset: 2 }}>
          <div className="mail-copy">
            <span>
              2.
              ホットペッパー管理画面にて、1でコピーした取込専用メールアドレスを登録してください。
            </span>
          </div>
          <Row justify="center">
            <div className="link-to-web">
              ...
              <div className="copy-clipboard">
                <a
                  href="https://www.cms.hotpepper.jp/"
                  target="_blank"
