...
const BucketList = ({ companyCode }) => {
  ...
  const params = {
    ...
    Prefix: `reservations/${companyCode}/hotpepper_auth`,
  };
  const onReload = () => {
    setMailContent("");
    setIsReload(true);
        ...
        <Col md={{ span: 20, offset: 2 }}>
          ...
          <div className="title-confirm-mail">
            <span style={{ display: "inline-block" }}>
              1. メール内の「以下をクリックして、機能メール設定を完了！」
            </span>
            <span style={{ display: "inline-block" }}>
              に記載されているURLをクリックしてください。
            </span>
          </div>
          <Row justify="center">
          ...
          <div className="title-confirm-mail">
            <p>
              <span style={{ display: "inline-block" }}>
                2.ホットペッパー管理画面にて、「基本設定」＞
              </span>
              <span style={{ display: "inline-block" }}>
                「機能メール設定」の「確認する」をクリック＞
              </span>
              <span style={{ display: "inline-block" }}>
                「機能メールの確認」から取込専用メールアドレスの横にある「内容確認」をクリックしてください。
              </span>
            </p>
          </div>
          <div className="title-confirm-mail">
            <span>3. 「予約個別通知」にチェックを入れ、登録してください。</span>
          </div>
        </Col>
      </Row>
    </div>
