...
const secretTootlTipTitle =
  "「食べログ店舗管理画面」にログイン＞「ネット予約管理画面」＞「ネット予約受付設定」の「予約通知の設定」からメールアドレスを登録してください。";
export default function TabelogRegistration() {
      ...
      <Row className="form-section">
        <Col md={{ span: 20, offset: 2 }}>
          <div className="registration-email-title">
            <span>
              食べログ管理画面にて取込専用メールアドレスを登録してください。
            </span>
          </div>
        ...
        <Col md={{ span: 20, offset: 2 }}>
          <div className="mail-copy">
            <span>
              2.
              食べログ管理画面にて、1でコピーした取込専用メールアドレスを登録してください。
            </span>
          </div>
          <Row justify="center">
            <div className="link-to-web">
              ...
              <div className="copy-clipboard">
                <a
                  href="https://ssl.tabelog.com/owner_account/login/"
                  target="_blank"
