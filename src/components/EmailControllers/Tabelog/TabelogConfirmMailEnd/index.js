...
function TabelogConFirmMailEnd({ oncheckEnd1, oncheckEnd2 }) {
      ...
      <Row className="form-section">
        <Col md={{ span: 22, offset: 2 }}>
          ...
          <Row justify="center" style={{ margin: "2rem 0 1rem 0" }}>
            <p className="footer-config-tabelog-end">
...
TabelogConFirmMailEnd.propTypes = {
  oncheckEnd1: PropTypes.func,
  oncheckEnd2: PropTypes.func,
};

export default TabelogConFirmMailEnd;
