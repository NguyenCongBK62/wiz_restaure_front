...
const tabelogConfirmMailReducer = (state = initialState, action) =>
  produce(state, (draft) => {
    switch (action.type) {
      case SET_ALL_MAIL_STATUS:
        draft.hostMailConfigStatus = action.payload;
        break;
      case CREATE_TABELOG_SUCCESS:
        draft.flagCreateSuccess = true;
        break;
      case RESET_CREATE_TABELOG_SUCCESS:
...
export default tabelogConfirmMailReducer;
